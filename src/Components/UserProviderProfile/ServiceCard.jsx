...
const ServiceCard = ({ 
  ...
  return (
    <Link to={`/${isGallery ? 'gallery' : 'service'}/${id}` + (isCurrentWork ? "?isCurrentWork=true" : "")} className="block w-full hover:shadow-lg transition-shadow rounded-xl overflow-hidden">
