            ...
            {fileType === "pdf" ? (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M18.375 12.739l-7.693 7.693a1.875 1.875 0 01-2.652 0l-1.5-1.5a1.875 1.875 0 010-2.652l.932-.931m5.428-5.428a1.875 1.875 0 010-2.652l2.652-2.652a1.875 1.875 0 012.652 0l1.5 1.5a1.875 1.875 0 010 2.652l-2.652 2.652m-5.428 5.428l5.428-5.428"
                />
              </svg>
            )}
          </div>
