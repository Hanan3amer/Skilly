  ...
  return (
    <article className="grow py-6 max-md:py-5 max-sm:py-4 w-full rounded-xl bg-neutral-100 dark:bg-gray-800 transition-colors duration-300 max-md:mt-8 max-sm:mt-6 max-md:max-w-full overflow-hidden">
      <div className="flex flex-col px-8 max-md:px-6 max-sm:px-4 w-full max-md:max-w-full">
        ...
        <h4 className="self-end mt-5 max-md:mt-4 max-sm:mt-3 text-xs font-bold text-right text-blue-500 dark:text-blue-400">
          {title}
        </h4>
      </div>
      <div className="flex flex-col px-11 max-md:px-8 max-sm:px-5 mt-5 max-md:mt-4 max-sm:mt-3 w-full text-right max-md:max-w-full">
        <p className="text-xs font-light text-blue-950 dark:text-gray-300 max-md:max-w-full line-clamp-3 max-md:line-clamp-2">
          {description}
        </p>
